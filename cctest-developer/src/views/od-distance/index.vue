<template>
    <div class="od-distance">
        <div class="distance-top">
            {{data}}
              <!-- <od-distance :data="item"></od-distance> -->
                  <!-- <template v-if="item.test_item=='od_angle'">
                    <headTitle   :title="'OD朝向'"></headTitle>
                    <odDirection></odDirection>
                 </template>
                  <template v-if="item.test_item=='od_speed_use_kl'">
                    <headTitle   :title="'OD相对速度'"></headTitle>
                    <odSpeed></odSpeed>
                 </template> -->
                <!-- <headTitle  v-if="item.test_item=='od_distance_use_kl' || item.test_item=='od_distance'" :title="'OD测距'"></headTitle>
                <headTitle  v-else-if="item.test_item=='od_angle_use_kl'" :title="'OD朝向'"></headTitle>
                <headTitle  v-else-if="item.test_item=='od_speed_use_kl'" :title="'OD相对速度'"></headTitle> -->
            ...
            <el-card class="box-card">
                ...
                <div class="top-panel">
                     <div id="distance-total" class="suites"></div>
                </div>
            </el-card>
        </div>
        <div class="distance-center">
            <el-card class="box-card">
                ...
                <div class="distance-center-panel">
                    <div id="distance-suites" class="suites"></div>
                </div>
            </el-card>
             <el-card class="box-card right-card">
                ...
                <div class="distance-center-panel">
                    <div id="distance-features" class="suites"></div>
                </div>
             ...
             <el-card class="box-card">
                ...
                <div class="tab-panel">
                    <el-tabs v-model="activeName" type="card" >
                        <template v-for="(item,index) in distanceData.accuracy">
...
export default {
    ...
    mounted(){
        ...
        this.initSuites();
        this.initFeatures();
        this.activeName = this.distanceData.accuracy[0].class_name;
    },
    ...
    methods:{
        ...
        initSuites(){
                this.myChart = echarts.init(document.getElementById('distance-suites'));
        ...
        initFeatures(){
                this.myChart = echarts.init(document.getElementById('distance-features'));
                var spNum = 5,_max=100;
                var y_data = ['car_distance_test', 'bus_distance_test', 'truck_distance_test', 'person_distance_test', 'cyclist_distance_test'];
                var _data1 = [10,15,10,13,15,11];
                var _data2 = [19,5,40,33,15,51];
