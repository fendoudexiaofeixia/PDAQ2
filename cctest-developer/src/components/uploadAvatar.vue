...
<template>
	<div :photo="photo">
		<el-dialog class="avatar-uploader quying-dialog" title="修改头像"  :visible.sync="dialogVisible" width="600px" :before-close="handleClose" :close-on-press-escape="false" :close-on-click-modal="false" ref="editAvatar">
			<div class="avatar-uploader-wrap">
				...
				<div class="avatar-uploader__choose avatar-uploader_left" v-show="!photo && !isSuccess">
					...
					<input type="file" v-show="false" ref="fileinput" accept=".jpg, .jpeg, .png" @change="handleChange">
				</div>
				<!-- step2 -->
				<div class="avatar-uploader__edit" v-show="photo || isSuccess">
					<div class="avatar-uploader_left avatar-uploader__edit-area">
						...
						:fixed="cropper.fixed" 
						:fixedNumber="cropper.fixedNumber"></vueCropper>
					</div>
					<input type="file" v-show="false" ref="fileinput" accept=".jpg, .jpeg, .png" @change="handleChange">
...
<style lang="less" >
	...
	.avatar-uploader__edit{
		.avatar-uploader__edit-area{
			overflow: hidden;
		}
		.avatar-uploader__edit-img{
			object-fit: cover; 
		}
		button{
			margin-top: 13px
	...
	.avatar-uploader__preview{
		...
		align-items: center;
		font-size: 13px;
		.avatar-uploader__preview-title{
			color: #999999;
		}
		img{
			background: #fff;
	...
	.avatar-uploader__preview-120{
		height: 60px;
		width: 60px;
	}
	.avatar-uploader__preview-65{
		height: 45px;
		width: 45px;
	}
	.avatar-uploader__preview-40{
		height: 30px;
		width: 30px;
	}
	.quying-dialog{
